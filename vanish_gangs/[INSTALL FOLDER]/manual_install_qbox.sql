...
ALTER TABLE `users` ADD COLUMN `gang` VARCHAR(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL;
ALTER TABLE `users` ADD COLUMN `gang_rank` INT(11) DEFAULT NULL;