...
Cfg = {
    ...
    Options = {
        ...
        Teleporter = {
            ...
            enter = vec4(-1107.803833, 2722.764160, 18.800402, 201.577499), -- Teleporter entrance (vec4)
        ...
        MoneyWash = {
            ...
            max = 1000000000000000000000000,                -- Maximum amount of money that can be washed, does not apply when currency = 'markedbills'
            tax = 4,                   -- Tax percentage (0-100)
