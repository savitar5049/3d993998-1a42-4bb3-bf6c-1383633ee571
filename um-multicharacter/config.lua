...
Config.Lang = 'en'             -- [locales/.lua] (en, de, es, fr, pt, tr, zh)
...
Config.DefaultSpawn = vector4(-269.66, -956.61, 31.22, 213) -- [new character here]
...
Config.Relog = {
    ...
    Command = 'relog', -- If you want to use relog, you can change the command.
}
...
Config.Coords = {
    Single = Coords.List[13], -- If random false [list/coordslist.lua] | all coords = https://alp1x.github.io/um-multi-coords/
    Random = false
}
...
Config.TimeSettings = {
    ...
    Event = function(bool)
        TriggerEvent('vSync:toggle', bool) -- vSync or cd_easytime
    end,
